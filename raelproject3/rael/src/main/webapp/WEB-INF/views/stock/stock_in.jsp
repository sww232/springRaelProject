			...
			<div id="content">
				...
				<div class="card shadow mb-4">
					<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
						<h6 class="m-0 font-weight-bold text-primary">입고</h6>
					</div>
					<div class="card-body">
						<p>가격은 변경 가능 합니다.
						<div class="my-2"></div>
						...
						<form action='/stock/stock_in/INSERT' method="post">
							<input type='hidden' name='stock num' value="${stocknum}" readonly> <input type='hidden' name='stock name' value="${stockname}" readonly> <input type='hidden' name='stock state' value='입' readonly>
							<div>
								<ul>
									<li>
										<div class="input-group">
											<input type='number' class="form-control bg-light border-0 small" name='stock quantity' placeholder="입고 수량을 입력해주세요.">
										</div>
									</li>
									<li>
										<div class="input-group">
