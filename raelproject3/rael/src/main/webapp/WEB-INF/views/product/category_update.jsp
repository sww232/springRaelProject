												...
												<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
													...
													<tbody>
														<c:forEach items="${datas.list}" var="data">
															<input type="hidden" value=${data.PRODUCTCATEGORYNUM } class="form-control bg-light border-0 small" name="product category num for modify" readonly>
															<tr>
																<td>${data.PRODUCTCATEGORYNUM}</td>
																<td><input type="text" value="${data.PRODUCTCATEGORYNAME}" class="form-control bg-light border-0 small" name="product category name for modify"></td>
															<tr>
														</c:forEach>
													</tbody>
												</table>
											...
											<div class="dataTables_paginate paging_simple_numbers" id="dataTable_paginate">
												<ul class="pagination">
													...
													<c:if test="${datas.pagination.existNextPage eq true}">
														<li class="paginate_button page-item next" id="dataTable_next"><a aria-controls="dataTable" data-dt-idx="${num}" class="page-link" href='<c:url value="/product/category_update?page=${datas.pagination.endPage+1}&recordSize=${recordSize}&pageSize=${pageSize}&categoryBox=${categoryBox}"/>'>NEXT</a></li>
													</c:if>
												</ul>
											</div>
										</div>
