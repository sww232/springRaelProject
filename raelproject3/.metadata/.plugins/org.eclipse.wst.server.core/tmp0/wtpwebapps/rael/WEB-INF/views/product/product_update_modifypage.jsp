	...
	<div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
               ...
               <form method="post" action="product_update/UPDATE">
    <!-- End of Topbar -->
			    <div class="card shadow mb-4">
					...
					<div class="card-body">
						<p>
							<label>수정할 상품 명</label>
							<input type="text" class="form-control bg-light border-0 small" name="product name for modify" value="${data.PRODUCTNAME}" style="text-align:center; width:300px">
							<div class="input-group-append">
