			...
			<div id="content">
				...
				<form method="POST" action="/product/category_insert/INSERT">
					<ul>
						...
						<li>
							<div class="input-group">
								<input type="text" class="form-control bg-light border-0 small" name="productcategory name" placeholder="상품 분류 명을 입력해주세요(ex. 전자찌)" autocomplete="off">
							</div>
						</li>
