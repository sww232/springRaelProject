        ...
        <div id="content-wrapper" class="d-flex flex-column">
			...
			<div class="card shadow mb-4">
				<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
					<h6 class="m-0 font-weight-bold text-primary">상풍 분류 등록 양식</h6>
				</div>
				<div class="card-body">
					<p>
						대 븐류 -> 중 분류 -> 소 분류 로 작성해야 한다.
					</p>
					<p>
						예를 들어서 <code>300 민물용품</code>은 <code>대</code> 분류로 구분된다.
						그 안에 <code>중</code> 분류로는 
						<code>310 채비</code>, <code>소</code> 분류로는 <code>311 라인, 312 도래홀더 스토퍼...</code>
						등등 이 있다.
						<code>300 민물용품</code>에 포함되는 <code>소</code> 분류는 <code>301 봉돌</code> 처럼 등록 하면 된다.
					</p>
				</div>
			</div>
			
	
			<form method="POST" action="/product/category_insert/INSERT">
				<ul>
					<li>
						<div class="input-group">
							<input type="text" class="form-control bg-light border-0 small" name="productcategory num" placeholder="상품 분류 번호를 입력해주세요(ex. 100)" autocomplete="off">
						</div>
					</li>
					<li>
						<div class="input-group">
							<input type="text" class="form-control bg-light border-0 small" name="productcategory name" 
							placeholder="상품 분류 명을 입력해주세요(ex. 전자찌)" autocomplete="off">
						</div>
					</li>
