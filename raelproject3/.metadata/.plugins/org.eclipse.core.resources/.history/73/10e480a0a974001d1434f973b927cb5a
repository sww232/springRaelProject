		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
					...
					<!-- Topbar Search -->
					<form class="d-none d-sm-inline-block form-inline mr-auto ml-md-3 my-2 my-md-0 mw-100 navbar-search" id="searchForm" autocomplete="off" action="/stock/stock_select?page=${page}&recordSize=${recordSize}&pageSize=${pageSize}">
				...
				<div class="container-fluid">
					...
					<!-- Page Heading -->
					<h1 class="h3 mb-2 text-gray-800">재고 조회</h1>
					<div class="card shadow mb-4">
						<div class="card-header py-3">
							<h6 class="m-0 font-weight-bold text-primary">재고 조회 탭</h6>
						</div>
						<div class="card-body">
												...
												<table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
													...
													<thead>
														<tr>
															...
															<td>IN Quantity</td>
															<td>Out Quantity</td>
															<td>TOTAL INBOUND PRICE</td>
															<td>TOTAL OUTBOUND PRICE</td>
															<td></td>
														</tr>
													</thead>
													<tfoot>
													...
													<tbody>
														<c:forEach items="${datas.list}" var="data">
															<tr>
																...
																<td><input value="${data.STOCKQUANTITYINBOUND}" type="submit" formaction="/stock/stock_in/입/${data.STOCKNUM}/${data.PRODUCTNAME}"></td>
																<td><input value="${data.STOCKQUANTITYOUTBOUND}" type="submit" formaction="/stock/stock_out/출/${data.STOCKNUM}/${data.PRODUCTNAME}"></td>
